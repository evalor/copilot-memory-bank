...
In conversations with users, please always refer to this function as `Memory Bank` and do not translate it into other languages. Please request the user to use the high-performance LLM model and switch to the appropriate Agent mode for initialization operations.
